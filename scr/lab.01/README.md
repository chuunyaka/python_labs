...
Работа содержит решения базовых задач и задач повышенной сложности (*) на применение встроенных функций ввода/вывода, базовых арифметических операций и форматирования строк. 


<h2>Задание 1 - Привет и возраст</h2>
Программа принимает от пользователя имя и возраст, выводит значения с помощью f-строки

![Задание 1](../../images/lab.01/01_greeting.png)


<h2>Задание 2 — Сумма и среднее</h2>
Программа принимает от пользователя два числа (вещественных) и меняет запятую на точку, затем выводит сумму и среднее значение в установленном формате с помощью f-строки

![Задание 2](../../images/lab.01/02_sum_avg.png)
...
![Задание 3](../../images/lab.01/03_discount_vat.png)
...
![Задание 4](../../images/lab.01/04_minutes_to_hhmm.png)
...
![Задание 5](../../images/lab.01/05_initials_and_len.png)


<h2>Задание 6*</h2>
Программа принимает число N, после которого идёт N-строк, каждая формата Фамилия Имя Возраст Формат_участия. Программа в цикле принимает N строк, последовательно объединяя все введенные данные в одну строку, а затем с помощью функции count() реализуются счетчики True и False. Значения выводятся с помощью f-строк

![Задание 6](../../images/lab.01/ex.06.png)
...
![Задание 7](../../images/lab.01/ex.07.png)